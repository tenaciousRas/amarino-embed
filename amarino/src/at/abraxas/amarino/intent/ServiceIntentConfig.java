 ...
 * 
 */
public interface ServiceIntentConfig {

	/**
	 * Activity Action: Tell <i>Amarino</i> to connect to a device
	 * <p>
	 * Input:
	 * <em>{@link at.abraxas.amarino.intent.DefaultServiceIntentConfig#EXTRA_DEVICE_ADDRESS}</em>
	 ...
	 * 
	 * <pre>
	 * Intent intent = new Intent(DefaultServiceIntentConfig.ACTION_CONNECT);
	 * intent.putExtra(DefaultServiceIntentConfig.EXTRA_DEVICE_ADDRESS, DEVICE_ADDRESS);
	 ...
	 * 
	 * <pre>
	 * Intent intent = new Intent(DefaultServiceIntentConfig.ACTION_DISCONNECT);
	 * intent.putExtra(DefaultServiceIntentConfig.EXTRA_DEVICE_ADDRESS, DEVICE_ADDRESS);
	 * sendBroadcast(intent);
	 * </pre>
	 */
	 ...
	 * 				DefaultServiceIntentConfig.EXTRA_DATA_TYPE, -1);
	 * 
	 * 		if (dataType == DefaultServiceIntentConfig.STRING_EXTRA) {
	 * 			data = intent.getStringExtra(DefaultServiceIntentConfig.EXTRA_DATA);
	 * 
	 * 			if (data != null) {
